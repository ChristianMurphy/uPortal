...
Documentation for earlier versions of uPortal is available in[Confluence](https://wiki.jasig.org).  See *Documentation for Previous Releases*
below.
  ...
  <tr>
    ...
    <td>
      <table>
        ...
        <tr>
          <td>Demander une fonctionnalité</td>
          <td>
            <a href="https://issues.jasig.org/browse/UP">
              <img src="https://img.shields.io/badge/issue_tacker-Jira-green.svg?style=flat" alt="Issue Tracker">
            </a>
        ...
        <tr>
          <td> Apporter des changements</td>
          <td>
        ...
        <tr>
          <td>Rejoindre la conversation</td>
          <td>
...
- [Mise en œuvre de uPortal](implement/README.md)
- [Au thème uPortal](SKINNING_UPORTAL.md)
- [En utilisant Angular](USING_ANGULAR.md)
...
## Documentation des versions uPortal précédentes
